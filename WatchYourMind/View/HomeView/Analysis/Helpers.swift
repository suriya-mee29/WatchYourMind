...
public struct Colors2 {
    ...
    public static let SleepingColor:Color = Color("SleepingColor")
}
...
public struct GradientColors {
    public static let orange = GradientColor(start: Colors2.OrangeStart, end: Colors2.OrangeEnd)
    public static let blue = GradientColor(start: Colors2.GradientPurple, end: Colors2.GradientNeonBlue)
...
public struct Styles {
    public static let lineChartStyleOne = ChartStyle2(
        ...
        accentColor: Colors2.OrangeStart,
        secondGradientColor: Colors2.OrangeEnd,
    ...
    public static let barChartStyleNeonBlueLight = ChartStyle2(
        backgroundColor: Color.white,
        accentColor: Colors2.GradientNeonBlue,
        secondGradientColor: Colors2.GradientPurple,
        textColor: Color.black,
        legendTextColor: Color.gray,
        dropShadowColor: Color.gray)
    ...
    public static let pieChartStyleOne = ChartStyle2(
        backgroundColor: Color.white,
        accentColor: Colors2.OrangeEnd,
        secondGradientColor: Colors2.OrangeStart,
        textColor: Color.black,
        legendTextColor: Color.gray,
        dropShadowColor: Color.gray)
...
public class ChartStyle2 {
    ...
    public init(formSize: CGSize){
        ...
        self.accentColor = Colors2.OrangeStart
...
public class ChartData2: ObservableObject, Identifiable {
...
public class MultiLineChartData: ChartData2 {
...
public class TestData{
    static public var data:ChartData2 = ChartData2(points: [37,72,51,22,39,47,66,85,50])
    static public var values:ChartData2 = ChartData2(values: [("2017 Q3",220),
                                                            ("2017 Q4",1550),
                                                            ("2018 Q1",8180),
                                                            ("2018 Q2",18440),
                                                            ("2018 Q3",55840),
